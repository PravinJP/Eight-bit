        ...
        <div className="flex justify-center items-center flex-col">
          <div>
            <p className="text-center text-white text-5xl font-medium">
              Innovate. Build. Grow. <br /> End-to-End Web, App & SaaS Development.
            </p>
          </div>
          <div className="mt-2">
            <p className="text-center text-white">
              Tailored digital solutions — from concept to launch, built to empower <br />
