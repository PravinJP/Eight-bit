...
const LandingPage = () => {
  ...
  return (
    <div className="Landing-Page relative bg-gradient-to-b from-[#201F01] to-[#212121]  overflow-x-clip  flex flex-col items-center gap-16 px-4 md:px-8 lg:px-16 pb-0 py-9 ">
      {/* Background Gradient Image - Positioned Absolutely Behind */}
      <motion.img
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.5, duration: 0.6, ease: "easeOut" }}
        className="absolute -top-[550px] blur-2xl  left-[-388] w-[1374.03] h-[923.23] ml-92 mt-20   opacity-70 pointer-events-none"
        src="/Group 39876.svg"
        alt="gradient"
      />
