...
const LandingPage = () => {
  return (
    <div className="Landing-Page relative bg-gradient-to-b from-[#201F01] to-[#212121] noise-bg-blend  overflow-x-clip  flex flex-col items-center gap-16 px-4 md:px-8 lg:px-16 py-9 ">
